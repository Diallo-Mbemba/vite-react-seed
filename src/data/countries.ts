...
export const COUNTRIES: Country[] = [
  ...
  { code: 'AI', name: 'Anguilla', nameEn: 'Anguilla' },
  { code: 'AQ', name: 'Antarctique', nameEn: 'Antarctica' },
  ...
  { code: 'CD', name: 'Congo (République démocratique)', nameEn: 'Congo (Democratic Republic)' },
  ...
  { code: 'LR', name: 'Libéria', nameEn: 'Liberia' },
  ...
  { code: 'MH', name: 'Marshall', nameEn: 'Marshall Islands' },
  ...
  { code: 'NG', name: 'Nigéria', nameEn: 'Nigeria' },
  ...
  { code: 'KN', name: 'Saint-Kitts-et-Nevis', nameEn: 'Saint Kitts and Nevis' },
  ...
  { code: 'ST', name: 'Sao Tomé-et-Principe', nameEn: 'Sao Tome and Principe' },
  ...
  { code: 'CZ', name: 'Tchéquie', nameEn: 'Czech Republic' },
  ...
  { code: 'VN', name: 'Viêt Nam', nameEn: 'Vietnam' },
...
// Fonction utilitaire pour obtenir un pays par son nom
